    ...
    <section className="relative bg-paper text-ink min-h-[100dvh] flex flex-col justify-center overflow-hidden">
      <div className="max-w-6xl mx-auto px-5 sm:px-8 md:px-12 pt-24 sm:pt-28 pb-16 sm:pb-20 w-full text-center">
        ...
        <div className="relative w-full overflow-hidden mb-12 sm:mb-16">
          <div className="hero-carousel flex w-[200%]">
            {/* Slide 1: Logo */}
            <div className="w-1/2 flex-shrink-0 flex items-center justify-center min-h-[280px] sm:min-h-[340px]">
              <Logo animated />
            </div>

            {/* Slide 2: Heading + description + CTAs */}
            <div className="w-1/2 flex-shrink-0 flex flex-col items-center justify-center min-h-[280px] sm:min-h-[340px] px-4">
              <h1
