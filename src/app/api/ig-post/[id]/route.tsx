...
export async function GET(
  ...
  const [
    instrumentRegular, instrumentItalic, outfitMedium, outfitBold, jetbrainsMono,
    interMedium, interBold, interBlack,
    pinyonScript, cormorantLight, cormorantMedium, cormorantBold, cormorantItalic,
    jostMedium, jostBold,
  ] = await Promise.all([
    ...
    loadGoogleFont("family=Pinyon+Script"),
    loadGoogleFont("family=Cormorant+Garamond:wght@300"),
    loadGoogleFont("family=Cormorant+Garamond:wght@500"),
    loadGoogleFont("family=Cormorant+Garamond:wght@700"),
    loadGoogleFont("family=Cormorant+Garamond:ital@1"),
    loadGoogleFont("family=Jost:wght@500"),
    loadGoogleFont("family=Jost:wght@700"),
  ]);
  ...
  const responseOpts = {
    ...
    fonts: [
      ...
      { name: "Pinyon Script", data: pinyonScript, weight: 400 as const, style: "normal" as const },
      { name: "Cormorant Garamond", data: cormorantLight, weight: 300 as const, style: "normal" as const },
      { name: "Cormorant Garamond", data: cormorantMedium, weight: 500 as const, style: "normal" as const },
      { name: "Cormorant Garamond", data: cormorantBold, weight: 700 as const, style: "normal" as const },
      { name: "Cormorant Garamond", data: cormorantItalic, weight: 400 as const, style: "italic" as const },
      { name: "Jost", data: jostMedium, weight: 500 as const, style: "normal" as const },
      { name: "Jost", data: jostBold, weight: 700 as const, style: "normal" as const },
    ],
    headers: {
  ...
  // ─── ILLUMINATE BEAUTY BAR — Homepage Preview (client mockup, v2) ─────────
  if (post.customLayout === "illuminate-preview") {
    ...
    const ivory = "#FAF4E8";       // warm hero background
    const cream = "#F0E2CB";       // panel block
    const ink = "#3D2A1F";         // warm chocolate brown, not black
    const inkSoft = "rgba(61,42,31,0.62)";
    const gold = "#C39E60";        // rich champagne gold
    const goldDeep = "#8A6630";    // deeper accent
    const pinkSoft = "#ECD2CD";    // dusty rose panel
    const pinkDeep = "#B58B85";    // muted rose ink
    ...
    // Mini star helper for dense scatter
    const ScatterStar = ({ size, top, left, opacity, rot = 0, color = gold }: { size: number; top: number; left: number; opacity: number; rot?: number; color?: string }) => (
      <div style={{ position: "absolute", top, left, opacity, transform: `rotate(${rot}deg)`, display: "flex" }}>
        <svg width={size} height={size} viewBox="0 0 100 100" style={{ display: "flex" }}>
          <path d="M50 5 L61 38 L95 38 L67 58 L78 92 L50 71 L22 92 L33 58 L5 38 L39 38 Z" fill={color}/>
        </svg>
      </div>
    );
      ...
      (
        <div style={{
          ...
          <div style={{
            ...
            alignItems: "center",
            background: "#E6DDC9",
            borderBottom: "1px solid rgba(61,42,31,0.08)",
            padding: "13px 22px",
            gap: 8,
            flexShrink: 0,
          }}>
            <div style={{ display: "flex", width: 11, height: 11, borderRadius: 11, background: "#FF6058" }} />
            <div style={{ display: "flex", width: 11, height: 11, borderRadius: 11, background: "#FEBD2D" }} />
            ...
            <div style={{
              ...
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke={ink} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ display: "flex" }}>
          ...
          {/* ─── ANNOUNCEMENT STRIP — dark with gold ─── */}
          <div style={{
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            ...
            <svg width="11" height="11" viewBox="0 0 100 100" style={{ display: "flex" }}>
              <path d="M50 5 L61 38 L95 38 L67 58 L78 92 L50 71 L22 92 L33 58 L5 38 L39 38 Z" fill={gold}/>
            </svg>
            <div style={{
              fontFamily: "Jost",
              ...
              Now Booking Bridal  ·  Spring &amp; Summer &apos;26
            </div>
            <svg width="11" height="11" viewBox="0 0 100 100" style={{ display: "flex" }}>
              <path d="M50 5 L61 38 L95 38 L67 58 L78 92 L50 71 L22 92 L33 58 L5 38 L39 38 Z" fill={gold}/>
            </svg>
          ...
          {/* ─── TOP NAV — script wordmark left, nav center, BOOK right ─── */}
          <div style={{
            display: "flex",
            alignItems: "center",
            justifyContent: "space-between",
            background: ivory,
            padding: "22px 56px",
            borderBottom: `1px solid ${pinkSoft}`,
            flexShrink: 0,
          }}>
            <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 36 }}>
              {["Services", "Bridal", "Gallery", "About"].map((l) => (
                <div key={l} style={{
          ...
          <div style={{
            ...
            {/* DENSE star scatter — 22 stars at varying sizes/rotations */}
            <ScatterStar size={20} top={20}  left={90}  opacity={0.55} rot={5} />
            <ScatterStar size={10} top={85}  left={170} opacity={0.4}  rot={20} />
            <ScatterStar size={14} top={50}  left={250} opacity={0.5}  rot={-15} />
            <ScatterStar size={8}  top={150} left={120} opacity={0.4}  rot={10} />
            <ScatterStar size={18} top={210} left={60}  opacity={0.45} rot={-5} />
            <ScatterStar size={11} top={280} left={170} opacity={0.35} rot={15} />
            <ScatterStar size={9}  top={130} left={310} opacity={0.5}  rot={-25} />
            <ScatterStar size={13} top={40}  left={400} opacity={0.4}  rot={5} />
            <ScatterStar size={7}  top={110} left={460} opacity={0.55} rot={-10} />
            <ScatterStar size={22} top={35}  left={850} opacity={0.55} rot={10} />
            <ScatterStar size={12} top={130} left={920} opacity={0.45} rot={-20} />
            <ScatterStar size={9}  top={210} left={870} opacity={0.4}  rot={5} />
            <ScatterStar size={16} top={270} left={930} opacity={0.45} rot={25} />
            <ScatterStar size={11} top={70}  left={780} opacity={0.5}  rot={-15} />
            <ScatterStar size={8}  top={160} left={820} opacity={0.35} rot={10} />
            <ScatterStar size={14} top={320} left={780} opacity={0.4}  rot={-5} />
            <ScatterStar size={10} top={380} left={150} opacity={0.45} rot={20} />
            <ScatterStar size={11} top={400} left={920} opacity={0.45} rot={-10} />
            <ScatterStar size={9}  top={500} left={80}  opacity={0.4}  rot={15} />
            <ScatterStar size={12} top={550} left={970} opacity={0.45} rot={-5} />
            <ScatterStar size={7}  top={600} left={250} opacity={0.4}  rot={0} />
            <ScatterStar size={13} top={620} left={830} opacity={0.5}  rot={20} />

            {/* Hand-drawn gold dashed arc — large, sweeping */}
            <div style={{ position: "absolute", top: 96, left: "50%", transform: "translateX(-50%)", display: "flex" }}>
              <svg width="780" height="60" viewBox="0 0 780 60" style={{ display: "flex" }}>
                <path d="M20 35 Q200 0 390 28 Q580 56 760 18"
                  stroke={gold} strokeWidth="1.4" fill="none" opacity="0.55" strokeLinecap="round"
                  strokeDasharray="2 7"/>
              </svg>
            </div>
            ...
            <div style={{
              ...
              <div style={{ width: 36, height: 1, background: gold, display: "flex" }} />
              <div style={{
                fontFamily: "Cormorant Garamond",
                fontWeight: 500,
                fontSize: 16,
            ...
            {/* B E A U T Y B A R caps with gold rules */}
            <div style={{
              display: "flex",
              alignItems: "center",
              gap: 18,
              ...
              <div style={{ width: 60, height: 1, background: gold, display: "flex" }} />
              <div style={{
                fontFamily: "Cormorant Garamond",
                fontWeight: 500,
                fontSize: 32,
            ...
            <div style={{
              ...
              padding: "20px 44px",
              borderRadius: 0,
              boxShadow: "0 14px 30px rgba(195,158,96,0.35)",
              position: "relative",
              marginBottom: 24,
            }}>
            ...
            <div style={{
              ...
              <div style={{ display: "flex" }}>Haddon Township, NJ</div>
              <div style={{ width: 3, height: 3, borderRadius: 3, background: gold, display: "flex" }} />
              <div style={{ display: "flex" }}>Studio est. 2023</div>
              <div style={{ width: 3, height: 3, borderRadius: 3, background: gold, display: "flex" }} />
              <div style={{ display: "flex" }}>By Appointment</div>
            </div>
          </div>

          {/* ─── SERVICES — magazine TOC on pink panel ─── */}
          <div style={{
            display: "flex",
            flexDirection: "column",
            background: pinkSoft,
            ...
            <div style={{
              ...
              <div style={{ width: 40, height: 1, background: goldDeep, display: "flex" }} />
              <div style={{
                fontFamily: "Cormorant Garamond",
                fontWeight: 500,
                fontStyle: "italic",
            ...
            <div style={{ display: "flex", justifyContent: "space-between", gap: 0, paddingLeft: 12, paddingRight: 12 }}>
              {[
                { num: "I",   name: "Color",      from: "115", desc: "Touch ups, full color, balayage" },
                { num: "II",  name: "Cut",        from: "65",  desc: "Precision cut + blowdry" },
                { num: "III", name: "Extensions", from: "250", desc: "Hand tied, tape in, beaded" },
                { num: "IV",  name: "Makeup",     from: "185", desc: "Soft glam, editorial, bridal" },
              ].map((s, i) => (
                <div key={s.name} style={{
                  ...
                  borderLeft: i > 0 ? `1px solid ${pinkDeep}` : "none",
                }}>
                  <div style={{
                    fontFamily: "Cormorant Garamond",
                    fontStyle: "italic",
          ...
          {/* ─── BRIDAL FEATURE — centered editorial moment ─── */}
          <div style={{
            display: "flex",
            flexDirection: "column",
            alignItems: "center",
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 18 }}>
              <svg width="10" height="10" viewBox="0 0 100 100" style={{ display: "flex" }}>
                <path d="M50 5 L61 38 L95 38 L67 58 L78 92 L50 71 L22 92 L33 58 L5 38 L39 38 Z" fill={gold}/>
              </svg>
              <div style={{
                fontFamily: "Cormorant Garamond",
            ...
            <div style={{
              ...
              For the day you have pictured for years.
            </div>
            ...
            <div style={{
              ...
              Hair and makeup in a luxury one on one setting. Tell me about your day and I will write back inside 24 hours.
            </div>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <div style={{ fontFamily: "Pinyon Script", fontSize: 32, color: ivory, lineHeight: 1, display: "flex" }}>
                Illuminate
              </div>
              <div style={{
                fontFamily: "Cormorant Garamond",
