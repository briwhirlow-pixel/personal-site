...
const reviews = [
  {
    ...
    avatar: "MD",
    rating: 5,
    text: "Brian completely transformed our online presence. Before working with him, our old site was basically just a phone number on a white page. He built us a full restaurant site with our menu, a photo gallery, and an online reservation form — all mobile-friendly. Within the first month we saw a noticeable uptick in bookings coming directly through the website. He was responsive the entire time and delivered ahead of schedule. 10/10 would recommend to any local business owner.",
  ...
  },
  {
    ...
    avatar: "PS",
    rating: 5,
    text: "I came to Brian needing a Shopify store that actually felt premium — not just a generic template. He designed every page from scratch and integrated our product catalog, a loyalty rewards app, and email capture. The checkout flow he built converted way better than our old store. He also handled our SEO setup so we started showing up in Google searches we never ranked for before. Super professional, great communicator, and the site looks stunning.",
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <Reveal delay={300}>
          <div className="mt-14 flex flex-col sm:flex-row items-center justify-center gap-8 text-center">
            ...
            <p className="text-[#737373] text-[14px]">100% client satisfaction across 40+ projects</p>
            <div className="hidden sm:block w-px h-5 bg-[#E5E4DF]" />
